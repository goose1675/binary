...
export function PdfSwitcher() {
  ...
  return (
    <div>
      ...
      <button onClick={() => setPdfUrl("/Alcohols, Ether, and Halides Notes.pdf")}> Alcohols, Ethers, And Halides</button>
      <button onClick={() => setPdfUrl("/Alkanes, Alkenes, Alkynes Notes.pdf")}> Alkanes, Alkenes, And Alkynes</button>
      <button onClick={() => setPdfUrl("/Aldehyde, Ketones Notes.pdf")}> Aldehydes And Ketones</button>
      <button onClick={() => setPdfUrl("/Carboxylic Acid, Esters Notes.pdf")}>Carboxylic Acids And Esters</button>
